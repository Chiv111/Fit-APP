...
const SK="sebfit-v1";
async function loadLogs(){try{const raw=window.localStorage.getItem(SK);return raw?JSON.parse(raw):{}}catch{return {}}}
async function saveLogs(d){try{window.localStorage.setItem(SK,JSON.stringify(d))}catch{}}
